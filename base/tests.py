...
class ApiPermissionsTestCase(TestCase):
    ...
    def test_GetUsers(self):
        ...
        self.assertEqual(response.content, '{"count":2,"next":null,"previous":null,"results":[{"id":1,"username":"jane","email":"j.doe@tamu.edu","group":[]},{"id":2,"username":"alice","email":"a.doe@tamu.edu","group":[]}]}')
